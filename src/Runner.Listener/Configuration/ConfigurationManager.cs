...
namespace GitHub.Runner.Listener.Configuration
{
    ...
    public sealed class ConfigurationManager : RunnerService, IConfigurationManager
    {
        ...
        private async Task<GitHubAuthResult> GetTenantCredential(string githubUrl, string githubToken, string runnerEvent)
        {
            ...
            if (gitHubUrlBuilder.Host.Contains("github.com", StringComparison.OrdinalIgnoreCase) ||
                gitHubUrlBuilder.Host.Contains("github.localhost", StringComparison.OrdinalIgnoreCase))
            {
